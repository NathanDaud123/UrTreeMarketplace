...
const getProjectId = (): string => {
  ...
  return import.meta.env.VITE_SUPABASE_PROJECT_ID || "drrczqfikcyyqwqsncpk";
};
...
export const publicAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRycmN6cWZpa2N5eXF3cXNuY3BrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjY2MzI2ODQsImV4cCI6MjA4MjIwODY4NH0.KtiRJKaOcFooSscE3huy5NOXo_hFnUkZZqJMVxMLR0s";
